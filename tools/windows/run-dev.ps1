...
$process = Start-Process -FilePath $exe -WorkingDirectory $game -ArgumentList @('-ConfigFile','config.ini','-ScoreFile','Ultrastar-dev.db','-QueueBridge','.queue-bridge') -WindowStyle Normal -PassThru
